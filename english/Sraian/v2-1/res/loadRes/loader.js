 ...
 * @param {number} done - 已完成的章节数
 * @param {number} total - 总章节数
 * @param {string} url - 当前加载的章节URL
 * @param {{ok: boolean, data?: any, error?: Error}} result - 当前加载结果
 */
 ...
 * @param {(json: any) => boolean | Promise<boolean>} [options.validate]
 ...
 * @param {ChapterProgressCallback|null} [options.onProgress] - 进度回调函数
